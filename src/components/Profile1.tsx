	...
	return (
		<SafeAreaView style={styles.wrapper}>
			<View style={styles.header}>
				...
				/>
				<Text></Text>
				<Text style={styles.text}>Lucy Pevensie</Text>
			</View>
			<View style={styles.profilebox}>
				...
				<View style={styles.description}>
					<Text style={styles.personatext}>Graduated with 3.8 in Mobile Application Development </Text>
				</View>
